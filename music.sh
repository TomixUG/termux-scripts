...
# spotify
spotdl sync "https://open.spotify.com/playlist/4vGLQg0jj1d5H4xltzSxs0?si=01be5263d7b948b7" --save-file ~/termux-scripts/playlist.spotdl --output ~/storage/music/spotdl/mymusic
